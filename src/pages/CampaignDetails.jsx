  ...
  return (
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-8">
        ...
        <div className="flex md:w-40 w-full flex-wrap justify-between gap-8">
          <CountBox
            title="Days Left"
            value={remainingDays}
          />
      ...
      <div className="mt-16 flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-10">
          <div>
            ...
            <div className="mt-5 flex flex-row items-center flex-wrap gap-4">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-[#2c2f32] cursor-pointer">
                <img src={thirdweb} alt="user" className="w-3/5 h-3/5 object-contain" />
              </div>
          ...
          <div>
            ...
            <div className="mt-5">
              <p className="font-epilogue font-normal text-base text-[#808191] leading-7 text-justify">
                {state.description}
              </p>
            </div>
          </div>
            ...
            <div className="mt-5 flex flex-col gap-4">
              {donators.length > 0 ? donators.map((item, index) => (
                <div key={`${item.donator}-${index}`} className="flex justify-between items-center gap-4">
                  ...
                  <p className="font-epilogue font-normal text-base text-[#808191] leading-7 break-all">
                    {item.donation}
                  </p>
                </div>
              )) : (
